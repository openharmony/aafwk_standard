...
#ifndef FOUNDATION_ABILITYRUNTIME_OHOS_DATASHARE_EXT_ABILITY_H
#define FOUNDATION_ABILITYRUNTIME_OHOS_DATASHARE_EXT_ABILITY_H
...
#endif  // FOUNDATION_ABILITYRUNTIME_OHOS_DATASHARE_EXT_ABILITY_H