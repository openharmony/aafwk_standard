...
#ifndef ABILITY_UNITTEST_WANT_RECEIVER_STUB_IMPL_MOCK_H
#define ABILITY_UNITTEST_WANT_RECEIVER_STUB_IMPL_MOCK_H
...
namespace OHOS {
namespace AAFwk {
class WantReceiverStubImplMock : public WantReceiverStub {
public:
    WantReceiverStubImplMock()
    {}
    virtual ~WantReceiverStubImplMock()
    {}
...
#endif  // ABILITY_UNITTEST_WANT_RECEIVER_STUB_IMPL_MOCK_H