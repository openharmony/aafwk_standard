...
#ifndef FORM_ST_SERVICE_ABILITY_A_
#define FORM_ST_SERVICE_ABILITY_A_
#include <string>
#include <map>
...
class FormStServiceAbilityA : public Ability {
public:
...
private:
    ...
    typedef void (FormStServiceAbilityA::*func)();
    ...
    public:
        ...
        FormStServiceAbilityA *mainAbility_ = nullptr;
    };
};
}  // namespace AppExecFwk
}  // namespace OHOS
#endif  // FORM_ST_SERVICE_ABILITY_A_
