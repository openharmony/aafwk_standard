...
#ifndef _FORM_ABILITY_SELF_STARTING_A_H_
#define _FORM_ABILITY_SELF_STARTING_A_H_
...
class FormAbilitySelfStartingA : public Ability {
public:
    ~FormAbilitySelfStartingA();
    void SubscribeEvent();
    void handleEvent(std::string action, std::string data);

    void FMS_Start_0300_01(std::string data);
...
private:
    ...
    using FormFunc = void (FormAbilitySelfStartingA::*)(std::string data);
...
#endif  // _FORM_ABILITY_SELF_STARTING_A_H_