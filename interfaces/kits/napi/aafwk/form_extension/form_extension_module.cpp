...
void NAPI_application_FormExtension_AutoRegister()
{
    auto moduleManager = NativeModuleManager::GetInstance();
    NativeModule newModuleInfo = {
        .name = "application.FormExtension",
        .fileName = "application/libformextension_napi.so/FormExtension.js",
    };
...
void NAPI_application_FormExtension_GetJSCode(const char **buf, int *bufLen)
{
    if (buf != nullptr) {
...
extern "C" __attribute__((visibility("default")))
void NAPI_application_FormExtension_GetABCCode(const char **buf, int *buflen)
{
    if (buf != nullptr) {
