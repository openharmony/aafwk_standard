...
#ifndef OHOS_APPEXECFWK_INTERFACES_INNERKITS_GLOBAL_CONFIGURATION_KEY_H
#define OHOS_APPEXECFWK_INTERFACES_INNERKITS_GLOBAL_CONFIGURATION_KEY_H
...
#endif // OHOS_APPEXECFWK_INTERFACES_INNERKITS_GLOBAL_CONFIGURATION_KEY_H