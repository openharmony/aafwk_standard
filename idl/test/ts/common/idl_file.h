...
const std::string ERROR_INTERFACE_KEYWORD_IDL_CONTENT =
"lnterfaces idl.systemtest.IIdlTest {\n"
"    void voidParameterTypeVoid([in] int param1);\n"
"}";
...
const std::string CAPITALIZATION_ZIDL_NAME = "CapitalizationIdlTest.idl";

const std::string CAPITALIZATION_VOID_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.CapitalizationIdlTest {\n"
"    VOID voidOrderReturnVoid();\n"
"}";

const std::string CAPITALIZATION_BOOL_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.CapitalizationIdlTest {\n"
"    BOOLEAN voidOrderReturnBOOLEAN();\n"
"}";

const std::string CAPITALIZATION_INT_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.CapitalizationIdlTest {\n"
"    INT voidOrderReturnINT();\n"
"}";

const std::string CAPITALIZATION_STRING_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.CapitalizationIdlTest {\n"
"    STRING voidOrderReturnSTRING();\n"
"}";

const std::string CAPITALIZATION_INTERFACE_TYPE_ZIDL_CONTENT =
"INTERFACE idl.systemtest.CapitalizationIdlTest {\n"
"    int voidOrderReturnInt();\n"
"}";

const std::string CAPITALIZATION_IN_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.CapitalizationIdlTest {\n"
"    int voidOrderReturnInt([IN] int param1);\n"
"}";

const std::string CAPITALIZATION_OUT_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.CapitalizationIdlTest {\n"
"    void voidOrderReturnVoid([OUT] int param1);\n"
"}";

const std::string CAPITALIZATION_ONEWAY_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.CapitalizationIdlTest {\n"
"    [ONEWAY] void voidOrderReturnVoid();\n"
"}";

const std::string CAPITALIZATION_SEQUENCEABLE_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.IInterfaceDeclare;\n"
"SEQUENCEABLE idl.systemtest.MySequenceable;\n"
"interface idl.systemtest.CapitalizationIdlTest {\n"
...
const std::string CAPITALIZATION_MAP_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.CapitalizationIdlTest {\n"
"    MAP<int, int> voidOrderReturnMap();\n"
"}";

const std::string NO_LICENSE_ZIDL_NAME = "NoLicenseIdlTest.idl";

const std::string NO_LICENSE_VOID_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.NoLicenseIdlTest {\n"
"    void voidOrderReturnVoid();\n"
"}";

const std::string NO_LICENSE_BOOL_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.NoLicenseIdlTest {\n"
"    boolean voidOrderReturnBOOLEAN();\n"
"}";

const std::string NO_LICENSE_INT_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.NoLicenseIdlTest {\n"
"    int voidOrderReturnINT();\n"
"}";

const std::string NO_LICENSE_STRING_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.NoLicenseIdlTest {\n"
"    string voidOrderReturnSTRING();\n"
"}";

const std::string NO_LICENSE_INTERFACE_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.NoLicenseIdlTest {\n"
"    int voidOrderReturnInt();\n"
"}";

const std::string NO_LICENSE_IN_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.NoLicenseIdlTest {\n"
"    int voidOrderReturnInt([in] int param1);\n"
"}";

const std::string NO_LICENSE_OUT_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.NoLicenseIdlTest {\n"
"    void voidOrderReturnVoid([out] int param1);\n"
"}";

const std::string NO_LICENSE_ONEWAY_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.NoLicenseIdlTest {\n"
"    [oneway] void voidOrderReturnVoid();\n"
"}";

const std::string NO_LICENSE_SEQUENCEABLE_TYPE_ZIDL_CONTENT =
"sequenceable idl.systemtest.MySequenceable;\n"
"interface idl.systemtest.NoLicenseIdlTest {\n"
"    void voidOrderReturnVoid([in] MySequenceable mysequenceable);\n"
"}";

const std::string NO_LICENSE_MAP_TYPE_ZIDL_CONTENT =
"interface idl.systemtest.NoLicenseIdlTest {\n"
"    Map<int, int> voidOrderReturnMap();\n"
"}";

const std::string NO_INTERFACE_ZIDL_NAME = "NoInterfaceIdlTest.idl";

const std::string NO_INTERFACE_VOID_TYPE_ZIDL_CONTENT =
"idl.systemtest.NoInterfaceIdlTest {\n"
"    void voidOrderReturnVoid();\n"
"}";

const std::string NO_INTERFACE_BOOL_TYPE_ZIDL_CONTENT =
"idl.systemtest.NoInterfaceIdlTest {\n"
"    boolean voidOrderReturnBOOLEAN();\n"
"}";

const std::string NO_INTERFACE_INT_TYPE_ZIDL_CONTENT =
"idl.systemtest.NoInterfaceIdlTest {\n"
"    int voidOrderReturnINT();\n"
"}";

const std::string NO_INTERFACE_STRING_TYPE_ZIDL_CONTENT =
"idl.systemtest.NoInterfaceIdlTest {\n"
"    string voidOrderReturnSTRING();\n"
"}";

const std::string NO_INTERFACE_INTERFACE_TYPE_ZIDL_CONTENT =
"idl.systemtest.NoInterfaceIdlTest {\n"
"    int voidOrderReturnInt();\n"
"}";

const std::string NO_INTERFACE_IN_TYPE_ZIDL_CONTENT =
"idl.systemtest.NoInterfaceIdlTest {\n"
"    int voidOrderReturnInt([in] int param1);\n"
"}";

const std::string NO_INTERFACE_OUT_TYPE_ZIDL_CONTENT =
"idl.systemtest.NoInterfaceIdlTest {\n"
"    void voidOrderReturnVoid([out] int param1);\n"
"}";

const std::string NO_INTERFACE_ONEWAY_TYPE_ZIDL_CONTENT =
"idl.systemtest.NoInterfaceIdlTest {\n"
"    [oneway] void voidOrderReturnVoid();\n"
"}";

const std::string NO_INTERFACE_SEQUENCEABLE_TYPE_ZIDL_CONTENT =
"sequenceable idl.systemtest.MySequenceable;\n"
"idl.systemtest.NoInterfaceIdlTest {\n"
"    void voidOrderReturnVoid([in] MySequenceable mysequenceable);\n"
"}";

const std::string NO_INTERFACE_MAP_TYPE_ZIDL_CONTENT =
"idl.systemtest.NoInterfaceIdlTest {\n"
"    Map<int, int> voidOrderReturnMap();\n"
"}";
}
