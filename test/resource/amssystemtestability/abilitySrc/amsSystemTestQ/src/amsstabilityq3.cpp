...
{
    GetWantInfo(want);
    APP_LOGI("AmsStAbilityQ3::onStart");
...
{
    APP_LOGI("AmsStAbilityQ3::OnNewWant");
...
{
    APP_LOGI("AmsStAbilityQ3::OnForeground");
...
{
    APP_LOGI("AmsStAbilityQ3::onStop");
    Ability::OnStop();
...
{
    APP_LOGI("AmsStAbilityQ3::OnActive");
    Ability::OnActive();
...
{
    APP_LOGI("AmsStAbilityQ3::OnInactive");
    Ability::OnInactive();
