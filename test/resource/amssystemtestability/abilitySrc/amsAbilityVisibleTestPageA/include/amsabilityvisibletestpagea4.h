...
#ifndef AMS_ABILITY_VISIBLE_TEST_PAGE_A4
#define AMS_ABILITY_VISIBLE_TEST_PAGE_A4
...
class AmsAbilityVisibleTestPageA4 : public Ability {
protected:
...
#endif  // AMS_ABILITY_VISIBLE_TEST_PAGE_A4