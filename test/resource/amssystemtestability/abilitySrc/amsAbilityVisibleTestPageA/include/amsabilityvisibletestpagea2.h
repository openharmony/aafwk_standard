...
#ifndef AMS_ABILITY_VISIBLE_TEST_PAGE_A2
#define AMS_ABILITY_VISIBLE_TEST_PAGE_A2
...
class AmsAbilityVisibleTestPageA2 : public Ability {
protected:
...
#endif  // AMS_ABILITY_VISIBLE_TEST_PAGE_A2