...
#include "amsabilityvisibletestpagea1.h"
...
{
    APP_LOGI("AmsAbilityVisibleTestPageA1::Init");
...
void AmsAbilityVisibleTestPageA1::OnStart(const Want &want)
{
    GetWantInfo(want);
    APP_LOGI("AmsAbilityVisibleTestPageA1::onStart");
...
void AmsAbilityVisibleTestPageA1::OnNewWant(const Want &want)
{
    APP_LOGI("AmsAbilityVisibleTestPageA1::OnNewWant");
...
void AmsAbilityVisibleTestPageA1::OnForeground(const Want &want)
{
    APP_LOGI("AmsAbilityVisibleTestPageA1::OnForeground");
...
void AmsAbilityVisibleTestPageA1::OnStop()
{
    APP_LOGI("AmsAbilityVisibleTestPageA1::onStop");
    Ability::OnStop();
...
void AmsAbilityVisibleTestPageA1::OnActive()
{
    APP_LOGI("AmsAbilityVisibleTestPageA1::OnActive");
    Ability::OnActive();
...
void AmsAbilityVisibleTestPageA1::OnInactive()
{
    APP_LOGI("AmsAbilityVisibleTestPageA1::OnInactive");
    Ability::OnInactive();
...
void AmsAbilityVisibleTestPageA1::OnBackground()
{
    APP_LOGI("AmsAbilityVisibleTestPageA1::OnBackground");
...
void AmsAbilityVisibleTestPageA1::Clear()
{
    targetType_ = "";
    targetBundle_ = "";
    targetAbility_ = "";
...
void AmsAbilityVisibleTestPageA1::GetWantInfo(const Want &want)
{
    Want mWant(want);
...
std::string AmsAbilityVisibleTestPageA1::Split(std::string &str, std::string delim)
{
    std::string result;
    if (!str.empty()) {
...
REGISTER_AA(AmsAbilityVisibleTestPageA1);
}  // namespace AppExecFwk
}  // namespace OHOS