...
{
    HILOG_INFO("AmsAbilityVisibleTestPageA1::Init");
...
{
    GetWantInfo(want);
    HILOG_INFO("AmsAbilityVisibleTestPageA1::onStart");
...
{
    HILOG_INFO("AmsAbilityVisibleTestPageA1::OnNewWant");
...
{
    HILOG_INFO("AmsAbilityVisibleTestPageA1::OnForeground");
...
{
    HILOG_INFO("AmsAbilityVisibleTestPageA1::OnActive");
    Ability::OnActive();
...
{
    HILOG_INFO("AmsAbilityVisibleTestPageA1::OnInactive");
    Ability::OnInactive();
...
{
    HILOG_INFO("AmsAbilityVisibleTestPageA1::OnBackground");
