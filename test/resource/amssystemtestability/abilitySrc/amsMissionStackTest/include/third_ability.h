...
protected:
    ...
    std::shared_ptr<ThirdEventSubscriber> subscriber_;
};
class ThirdEventSubscriber : public EventFwk::CommonEventSubscriber {
public:
    explicit ThirdEventSubscriber(const EventFwk::CommonEventSubscribeInfo &sp) : CommonEventSubscriber(sp)
    {
        mapTestFunc_ = {
