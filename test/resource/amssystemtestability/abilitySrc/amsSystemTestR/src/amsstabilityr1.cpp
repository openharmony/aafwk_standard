...
{
    GetWantInfo(want);
    APP_LOGI("AmsStAbilityR1::onStart");
...
{
    APP_LOGI("AmsStAbilityR1::OnNewWant");
...
{
    APP_LOGI("AmsStAbilityR1::OnForeground");
...
{
    APP_LOGI("AmsStAbilityR1::onStop");
    Ability::OnStop();
...
{
    APP_LOGI("AmsStAbilityR1::OnActive");
    Ability::OnActive();
...
{
    APP_LOGI("AmsStAbilityR1::OnInactive");
    Ability::OnInactive();
...
{
    APP_LOGI("AmsStAbilityR1::OnBackground");
