...
#ifndef AMS_ABILITY_VISIBLE_TEST_PAGE_B1
#define AMS_ABILITY_VISIBLE_TEST_PAGE_B1
...
class AmsAbilityVisibleTestPageB1 : public Ability {
protected:
...
#endif  // AMS_ABILITY_VISIBLE_TEST_PAGE_B1